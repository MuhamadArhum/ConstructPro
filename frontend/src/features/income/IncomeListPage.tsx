...
export default function IncomeListPage() {
  ...
  const [createCategory, { isLoading: creatingCat }] = useCreateIncomeCategoryMutation();
      ...
      <Dialog open={catDialogOpen} onClose={() => { setCatDialogOpen(false); setNewCatName(''); }} maxWidth="sm" fullWidth>
        <DialogTitle>
          <Stack direction="row" sx={{ alignItems: 'center' }}>
            <Typography variant="h6" sx={{ flex: 1 }}>Manage Income Categories</Typography>
        ...
        <DialogContent>
          ...
          <Stack direction="row" spacing={1}>
            ...
            <Tooltip title="Add">
              <span>
                <IconButton onClick={handleAddCategory} disabled={!newCatName.trim() || creatingCat} color="success">
                  <AddIcon />
                </IconButton>
              </span>
            </Tooltip>
